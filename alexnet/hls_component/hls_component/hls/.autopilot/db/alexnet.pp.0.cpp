...
# 14 "alexnet.cpp"
__attribute__((sdx_kernel("alexnet_layer1", 0))) void alexnet_layer1(
    data_t *input_img,
    data_t *output_feat,
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=alexnet_layer1
# 19 "alexnet.cpp"
...
#pragma HLS INTERFACE s_axilite port=return
 ...
 data_t local_weights[96][3][11][11];
    data_t local_bias[96];


#pragma HLS ARRAY_PARTITION variable=local_weights complete dim=2


 VITIS_LOOP_36_1: for(int oc=0; oc<96; oc++) {
        local_bias[oc] = bias[oc];
        VITIS_LOOP_38_2: for(int ic=0; ic<3; ic++) {
            VITIS_LOOP_39_3: for(int kr=0; kr<11; kr++) {
                VITIS_LOOP_40_4: for(int kc=0; kc<11; kc++) {
#pragma HLS PIPELINE II=1
 local_weights[oc][ic][kr][kc] = weights[(oc*3*11*11) + (ic*11*11) + (kr*11) + kc];
                }
            }
        }
    }
    ...
    VITIS_LOOP_49_5: for (int r = 0; r < 55; r++) {
        VITIS_LOOP_50_6: for (int c = 0; c < 55; c++) {
            VITIS_LOOP_51_7: for (int oc = 0; oc < 96; oc++) {
#pragma HLS PIPELINE II=1

 data_t sum = local_bias[oc];


                VITIS_LOOP_57_8: for (int ic = 0; ic < 3; ic++) {
                    VITIS_LOOP_58_9: for (int kr = 0; kr < 11; kr++) {
                        VITIS_LOOP_59_10: for (int kc = 0; kc < 11; kc++) {

                            int img_r = (r * 4) + kr;
                            int img_c = (c * 4) + kc;
                            int img_idx = (ic * 227 * 227) + (img_r * 227) + img_c;
