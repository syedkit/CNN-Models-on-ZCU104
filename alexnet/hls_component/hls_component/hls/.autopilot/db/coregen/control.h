...
#define CONTROL_ADDR_INPUT_IMG_DATA   0x10
#define CONTROL_BITS_INPUT_IMG_DATA   64
#define CONTROL_ADDR_OUTPUT_FEAT_DATA 0x1c
#define CONTROL_BITS_OUTPUT_FEAT_DATA 64
