...
entity alexnet_layer1_control_s_axi is
generic (
...
end entity alexnet_layer1_control_s_axi;
...
architecture behave of alexnet_layer1_control_s_axi is
    ...
    constant ADDR_OUTPUT_FEAT_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_OUTPUT_FEAT_DATA_1 : INTEGER := 16#20#;
    constant ADDR_OUTPUT_FEAT_CTRL   : INTEGER := 16#24#;
    ...
    signal int_output_feat     : UNSIGNED(63 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_OUTPUT_FEAT_DATA_0 =>
                        rdata_data <= RESIZE(int_output_feat(31 downto 0), 32);
                    when ADDR_OUTPUT_FEAT_DATA_1 =>
                        rdata_data <= RESIZE(int_output_feat(63 downto 32), 32);
...
-- ----------------------- Register logic ----------------
    ...
    output_feat          <= STD_LOGIC_VECTOR(int_output_feat);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_output_feat(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_FEAT_DATA_0) then
                    int_output_feat(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_output_feat(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_output_feat(63 downto 32) <= (others => '0');
            elsif (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_FEAT_DATA_1) then
                    int_output_feat(63 downto 32) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_output_feat(63 downto 32));
                end if;
            end if;
        end if;
    end process;
