...
HLS_SOURCES = ../../../../alexnet_tbb.cpp ../../../../alexnet.cpp
...
$(ObjDir)/alexnet_tbb.o: ../../../../alexnet_tbb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../alexnet_tbb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/alexnet_tbb.d

$(ObjDir)/alexnet.o: ../../../../alexnet.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../alexnet.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/alexnet.d
