...
HD_PWD='D:/vivado_research_project/alexnet/mobilenet_project_1/mobilenet_project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alexnet_layer1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alexnet_layer1.tcl -notrace
