...
HD_PWD='D:/vivado_research_project/alexnet/mobilenet_project_1/mobilenet_project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alexnet_layer1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alexnet_layer1.tcl
