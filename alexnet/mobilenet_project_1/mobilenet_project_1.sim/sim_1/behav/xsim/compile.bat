...
REM
REM Generated by Vivado on Mon Mar 30 23:02:33 +0530 2026
...
echo "xvlog --incr --relax -prj alexnet_layer1_vlog.prj"
call xvlog  --incr --relax -prj alexnet_layer1_vlog.prj -log xvlog.log
