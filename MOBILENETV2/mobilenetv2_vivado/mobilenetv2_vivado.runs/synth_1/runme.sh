...
HD_PWD='D:/vivado_research_project/MOBILENETV2/mobilenetv2_vivado/mobilenetv2_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mobilenetv2_block.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mobilenetv2_block.tcl
