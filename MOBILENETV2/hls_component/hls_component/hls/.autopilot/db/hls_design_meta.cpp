...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("dw_weights_address0", 9, hls_out, 4, "ap_memory", "mem_address", 1),
	Port_Property("dw_weights_ce0", 1, hls_out, 4, "ap_memory", "mem_ce", 1),
	Port_Property("dw_weights_d0", 16, hls_out, 4, "ap_memory", "mem_din", 1),
	Port_Property("dw_weights_q0", 16, hls_in, 4, "ap_memory", "mem_dout", 1),
	Port_Property("dw_weights_we0", 1, hls_out, 4, "ap_memory", "mem_we", 1),
	Port_Property("dw_weights_address1", 9, hls_out, 4, "ap_memory", "MemPortADDR2", 1),
	Port_Property("dw_weights_ce1", 1, hls_out, 4, "ap_memory", "MemPortCE2", 1),
	Port_Property("dw_weights_d1", 16, hls_out, 4, "ap_memory", "mem_din", 1),
	Port_Property("dw_weights_q1", 16, hls_in, 4, "ap_memory", "MemPortDOUT2", 1),
	Port_Property("dw_weights_we1", 1, hls_out, 4, "ap_memory", "mem_we", 1),
	Port_Property("pw_weights_address0", 10, hls_out, 5, "ap_memory", "mem_address", 1),
	Port_Property("pw_weights_ce0", 1, hls_out, 5, "ap_memory", "mem_ce", 1),
	Port_Property("pw_weights_d0", 16, hls_out, 5, "ap_memory", "mem_din", 1),
	Port_Property("pw_weights_q0", 16, hls_in, 5, "ap_memory", "mem_dout", 1),
	Port_Property("pw_weights_we0", 1, hls_out, 5, "ap_memory", "mem_we", 1),
	Port_Property("pw_weights_address1", 10, hls_out, 5, "ap_memory", "MemPortADDR2", 1),
	Port_Property("pw_weights_ce1", 1, hls_out, 5, "ap_memory", "MemPortCE2", 1),
	Port_Property("pw_weights_d1", 16, hls_out, 5, "ap_memory", "mem_din", 1),
	Port_Property("pw_weights_q1", 16, hls_in, 5, "ap_memory", "MemPortDOUT2", 1),
	Port_Property("pw_weights_we1", 1, hls_out, 5, "ap_memory", "mem_we", 1),
};
const char* HLS_Design_Meta::dut_name = "mobilenetv2_block";
