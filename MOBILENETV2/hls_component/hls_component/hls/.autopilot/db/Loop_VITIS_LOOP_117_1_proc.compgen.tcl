...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { input_stream_din { O 16 vector } input_stream_full_n { I 1 bit } input_stream_write { O 1 bit } input_stream_num_data_valid { I 3 vector } input_stream_fifo_cap { I 3 vector } } \
} "
}
...
set InstName mobilenetv2_block_flow_control_loop_pipe_U
set CompName mobilenetv2_block_flow_control_loop_pipe
