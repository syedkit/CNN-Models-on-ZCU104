set moduleName Loop_VITIS_LOOP_117_1_proc
set isTopModule 0
...
set cdfgNum 8
set C_modelName {Loop_VITIS_LOOP_117_1_proc}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ input_tensor int 64 regular  }
	{ gmem0 int 16 regular {axi_master 0}  }
	{ input_stream int 16 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "input_tensor", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "input_stream", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ input_stream_din sc_out sc_lv 16 signal 2 } 
	...
	{ input_tensor sc_in sc_lv 64 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "input_stream", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "100363", "Max" : "100363"}
	, {"Name" : "Interval", "Min" : "100363", "Max" : "100363"}
]}
...
set Spec2ImplPortList { 
	...
	input_stream { ap_fifo {  { input_stream_din fifo_data_in 1 16 }  { input_stream_full_n fifo_status 0 1 }  { input_stream_write fifo_port_we 1 1 }  { input_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { input_stream_fifo_cap fifo_update 0 3 } } }
}
