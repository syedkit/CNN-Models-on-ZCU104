...
HD_PWD='D:/vivado_research_project/LENET/letnet_vivado/letnet_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lenet_kernel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lenet_kernel.tcl
