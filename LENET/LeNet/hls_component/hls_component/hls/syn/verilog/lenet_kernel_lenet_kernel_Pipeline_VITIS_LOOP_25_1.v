...
module lenet_kernel_lenet_kernel_Pipeline_VITIS_LOOP_25_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [9:0] trunc_ln27_fu_100_p1;
reg   [9:0] trunc_ln27_reg_135;
reg   [9:0] trunc_ln27_reg_135_pp0_iter1_reg;
reg   [15:0] gmem0_addr_read_reg_140;
wire   [63:0] zext_ln27_fu_115_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [10:0] i_fu_48;
wire   [10:0] add_ln25_fu_94_p2;
wire    ap_loop_init;
...
lenet_kernel_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln25_fu_88_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln25_fu_88_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln25_fu_94_p2 = (ap_sig_allocacmp_i_2 + 11'd1);
...
assign icmp_ln25_fu_88_p2 = ((ap_sig_allocacmp_i_2 == 11'd1024) ? 1'b1 : 1'b0);

assign local_in_address0 = zext_ln27_fu_115_p1;

assign local_in_ce0 = local_in_ce0_local;

assign local_in_d0 = gmem0_addr_read_reg_140;
...
assign trunc_ln27_fu_100_p1 = ap_sig_allocacmp_i_2[9:0];

assign zext_ln27_fu_115_p1 = trunc_ln27_reg_135_pp0_iter1_reg;

endmodule //lenet_kernel_lenet_kernel_Pipeline_VITIS_LOOP_25_1
