...
entity lenet_kernel_lenet_kernel_Pipeline_VITIS_LOOP_25_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of lenet_kernel_lenet_kernel_Pipeline_VITIS_LOOP_25_1 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln25_fu_88_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal trunc_ln27_fu_100_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal trunc_ln27_reg_135 : STD_LOGIC_VECTOR (9 downto 0);
    signal trunc_ln27_reg_135_pp0_iter1_reg : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal add_ln25_fu_94_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component lenet_kernel_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_sequential_init_U : component lenet_kernel_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln25_fu_88_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    i_fu_48 <= add_ln25_fu_94_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                trunc_ln27_reg_135 <= trunc_ln27_fu_100_p1;
                trunc_ln27_reg_135_pp0_iter1_reg <= trunc_ln27_reg_135;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln25_fu_94_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_2) + unsigned(ap_const_lv11_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln25_fu_88_p2)
    begin
        if (((icmp_ln25_fu_88_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln25_fu_88_p2 <= "1" when (ap_sig_allocacmp_i_2 = ap_const_lv11_400) else "0";
    local_in_address0 <= zext_ln27_fu_115_p1(10 - 1 downto 0);
    ...
    local_in_d0 <= gmem0_addr_read_reg_140;
    ...
    trunc_ln27_fu_100_p1 <= ap_sig_allocacmp_i_2(10 - 1 downto 0);
    zext_ln27_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln27_reg_135_pp0_iter1_reg),64));
end behav;
