...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename local_in \
    op interface \
    ports { local_in_address0 { O 10 vector } local_in_ce0 { O 1 bit } local_in_q0 { I 16 vector } } \
} "
} else {
...
set InstName lenet_kernel_flow_control_loop_pipe_sequential_init_U
set CompName lenet_kernel_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix lenet_kernel_ \
}"
} else {
