set moduleName lenet_kernel_Pipeline_VITIS_LOOP_25_1
set isTopModule 0
...
set cdfgNum 5
set C_modelName {lenet_kernel_Pipeline_VITIS_LOOP_25_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_in { MEM_WIDTH 16 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 16 regular {axi_master 0}  }
	{ sext_ln25 int 63 regular  }
	{ local_in int 16 regular {array 1024 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ local_in_we0 sc_out sc_logic 1 signal 2 } 
	{ local_in_d0 sc_out sc_lv 16 signal 2 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	local_in { ap_memory {  { local_in_address0 mem_address 1 10 }  { local_in_ce0 mem_ce 1 1 }  { local_in_we0 mem_we 1 1 }  { local_in_d0 mem_din 1 16 } } }
}
