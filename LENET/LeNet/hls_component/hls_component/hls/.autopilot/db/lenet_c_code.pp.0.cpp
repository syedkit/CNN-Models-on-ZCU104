...
__attribute__((sdx_kernel("lenet_kernel", 0))) void lenet_kernel(
    data_t *input_data,
    data_t *output_data,
    const data_t *weights
);
# 2 "lenet_c_code.cpp" 2
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=lenet_kernel
# 15 "lenet_c_code.cpp"
...
#pragma HLS ARRAY_PARTITION variable=local_in complete dim=1
 ...
 VITIS_LOOP_25_1: for(int i=0; i<1024; i++) {
#pragma HLS PIPELINE II=1
 local_in[0][i/32][i%32] = input_data[i];
    }


    VITIS_LOOP_31_2: for(int i=0; i<10; i++) {
#pragma HLS PIPELINE II=1
