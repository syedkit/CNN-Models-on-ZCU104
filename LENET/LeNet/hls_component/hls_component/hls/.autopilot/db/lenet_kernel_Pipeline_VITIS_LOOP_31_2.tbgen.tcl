set moduleName lenet_kernel_Pipeline_VITIS_LOOP_31_2
set isTopModule 0
...
set cdfgNum 5
set C_modelName {lenet_kernel_Pipeline_VITIS_LOOP_31_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_in { MEM_WIDTH 16 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 1}  }
	{ sext_ln31 int 63 regular  }
	{ local_in int 16 regular {array 1024 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_data","offset": { "type": "dynamic","port_name": "output_data","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln31", "interface" : "wire", "bitwidth" : 63, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln31 sc_in sc_lv 63 signal 1 } 
	{ local_in_address0 sc_out sc_lv 10 signal 2 } 
	{ local_in_ce0 sc_out sc_logic 1 signal 2 } 
	{ local_in_q0 sc_in sc_lv 16 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln31", "direction": "in", "datatype": "sc_lv", "bitwidth":63, "type": "signal", "bundle":{"name": "sext_ln31", "role": "default" }} , 
 	{ "name": "local_in_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "local_in", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln31 { ap_none {  { sext_ln31 in_data 0 63 } } }
	local_in { ap_memory {  { local_in_address0 mem_address 1 10 }  { local_in_ce0 mem_ce 1 1 }  { local_in_q0 mem_dout 0 16 } } }
}
