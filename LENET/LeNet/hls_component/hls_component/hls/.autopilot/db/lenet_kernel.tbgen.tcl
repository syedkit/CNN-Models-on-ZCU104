...
set C_modelArgList {
	...
	{ weights int 16 unused {pointer 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_data","offset": { "type": "dynamic","port_name": "input_data","bundle": "control_r"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_data","offset": { "type": "dynamic","port_name": "output_data","bundle": "control_r"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "input_data", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "output_data", "interface" : "axi_slave", "bundle":"control_r","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "weights", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ weights sc_in sc_lv 16 signal 4 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"lenet_kernel","role":"start","value":"0","valid_bit":"0"},{"name":"lenet_kernel","role":"continue","value":"0","valid_bit":"4"},{"name":"lenet_kernel","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"lenet_kernel","role":"start","value":"0","valid_bit":"0"},{"name":"lenet_kernel","role":"done","value":"0","valid_bit":"1"},{"name":"lenet_kernel","role":"idle","value":"0","valid_bit":"2"},{"name":"lenet_kernel","role":"ready","value":"0","valid_bit":"3"},{"name":"lenet_kernel","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "s_axi_control_r_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control_r", "role": "AWADDR" },"address":[{"name":"input_data","role":"data","value":"16"},{"name":"output_data","role":"data","value":"28"}] },
	...
	{ "name": "s_axi_control_r_BRESP", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "control_r", "role": "BRESP" } }, 
 	...
 	{ "name": "weights", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "weights", "role": "default" }}  ]}

set ArgLastReadFirstWriteLatency {
	lenet_kernel {
		gmem0 {Type I LastRead 1 FirstWrite -1}
		gmem1 {Type O LastRead 13 FirstWrite 2}
	...
	lenet_kernel_Pipeline_VITIS_LOOP_25_1 {
		gmem0 {Type I LastRead 1 FirstWrite -1}
		sext_ln25 {Type I LastRead 0 FirstWrite -1}
		local_in {Type O LastRead -1 FirstWrite 2}}
	lenet_kernel_Pipeline_VITIS_LOOP_31_2 {
...
set Spec2ImplPortList { 
	...
	weights { ap_none {  { weights in_data 0 16 } } }
}
