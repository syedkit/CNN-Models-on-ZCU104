...
HLS_SOURCES = ../../../../lenet_tb.cpp ../../../../lenet_c_code.cpp
...
$(ObjDir)/lenet_tb.o: ../../../../lenet_tb.cpp $(ObjDir)/.dir csim.mk
...
$(ObjDir)/lenet_c_code.o: ../../../../lenet_c_code.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../lenet_c_code.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/lenet_c_code.d
