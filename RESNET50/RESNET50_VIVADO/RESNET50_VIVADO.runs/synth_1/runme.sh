...
HD_PWD='D:/vivado_research_project/RESNET50/RESNET50_VIVADO/RESNET50_VIVADO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log resnet50_bottleneck.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source resnet50_bottleneck.tcl
