...
module resnet50_bottleneck_resnet50_bottleneck_Pipeline_VITIS_LOOP_61_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ap_idle,
        ap_ready,
        skip_connection_fifo_dout,
        skip_connection_fifo_empty_n,
        skip_connection_fifo_read,
...
output   ap_idle;
output   ap_ready;
input  [15:0] skip_connection_fifo_dout;
input   skip_connection_fifo_empty_n;
output   skip_connection_fifo_read;
...
output  [7:0] local_out_address0;
output   local_out_ce0;
input  [14:0] local_out_q0;
...
wire   [14:0] select_ln69_fu_258_p3;
reg   [14:0] select_ln69_reg_300;
wire   [63:0] zext_ln61_fu_173_p1;
wire  signed [63:0] sext_ln69_fu_218_p1;
reg    ap_block_pp0_stage0_11001_grp1;
reg    ap_block_pp0_stage0_11001_grp2;
wire    ap_block_pp0_stage0_01001_grp2;
reg    ap_block_pp0_stage0_11001_grp3;
reg   [19:0] phi_mul1_fu_82;
wire   [19:0] add_ln69_2_fu_178_p2;
wire    ap_loop_init;
reg   [19:0] ap_sig_allocacmp_phi_mul1_load;
reg   [8:0] ch_fu_86;
wire   [8:0] add_ln61_fu_164_p2;
reg   [8:0] ap_sig_allocacmp_ch_1;
reg    local_out_ce0_local;
wire   [19:0] zext_ln40_cast_fu_141_p1;
wire   [19:0] add_ln69_fu_184_p2;
wire   [20:0] shl_ln1_fu_190_p3;
wire   [63:0] zext_ln69_1_fu_198_p1;
wire   [63:0] add_ln69_1_fu_202_p2;
wire   [62:0] trunc_ln3_fu_208_p4;
wire  signed [15:0] sext_ln63_fu_238_p1;
wire   [15:0] added_fu_242_p2;
wire   [0:0] icmp_ln69_fu_252_p2;
wire   [14:0] trunc_ln66_fu_248_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln61_fu_158_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln61_fu_158_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        ap_sig_allocacmp_phi_mul1_load = 20'd0;
    end else begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_grp3) & (1'b0 == ap_block_pp0_stage0_subdone_grp3_done_reg))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001_grp3) & (1'b0 == ap_block_pp0_stage0_subdone_grp3_done_reg))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        skip_connection_fifo_read = 1'b1;
    end else begin
...
assign add_ln61_fu_164_p2 = (ap_sig_allocacmp_ch_1 + 9'd1);

assign add_ln69_1_fu_202_p2 = (zext_ln69_1_fu_198_p1 + output_tensor);

assign add_ln69_2_fu_178_p2 = (ap_sig_allocacmp_phi_mul1_load + 20'd3136);

assign add_ln69_fu_184_p2 = (ap_sig_allocacmp_phi_mul1_load + zext_ln40_cast_fu_141_p1);

assign added_fu_242_p2 = ($signed(skip_connection_fifo_dout) + $signed(sext_ln63_fu_238_p1));
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = (((m_axi_gmem1_0_BVALID == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp3_done_reg)) | ((m_axi_gmem1_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((skip_connection_fifo_empty_n == 1'b0) | ((m_axi_gmem1_0_AWREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem1_0_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp2 = ((m_axi_gmem1_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp3 = ((m_axi_gmem1_0_BVALID == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp3_done_reg));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone = (((m_axi_gmem1_0_BVALID == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp3_done_reg)) | ((m_axi_gmem1_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((skip_connection_fifo_empty_n == 1'b0) | ((m_axi_gmem1_0_AWREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp1 = ((m_axi_gmem1_0_AWREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp2 = ((m_axi_gmem1_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp3 = ((m_axi_gmem1_0_BVALID == 1'b0) & (ap_enable_reg_pp0_iter7 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp3_done_reg));
end
...
assign icmp_ln61_fu_158_p2 = ((ap_sig_allocacmp_ch_1 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln69_fu_252_p2 = (($signed(added_fu_242_p2) > $signed(16'd0)) ? 1'b1 : 1'b0);

assign local_out_address0 = zext_ln61_fu_173_p1;
...
assign m_axi_gmem1_0_AWADDR = gmem1_addr_reg_293;
...
assign m_axi_gmem1_0_WDATA = select_ln69_reg_300;
...
assign select_ln69_fu_258_p3 = ((icmp_ln69_fu_252_p2[0:0] == 1'b1) ? trunc_ln66_fu_248_p1 : 15'd0);

assign sext_ln63_fu_238_p1 = $signed(local_out_q0);

assign sext_ln69_fu_218_p1 = $signed(trunc_ln3_fu_208_p4);

assign shl_ln1_fu_190_p3 = {{add_ln69_fu_184_p2}, {1'd0}};

assign trunc_ln3_fu_208_p4 = {{add_ln69_1_fu_202_p2[63:1]}};

assign trunc_ln66_fu_248_p1 = added_fu_242_p2[14:0];

assign zext_ln40_cast_fu_141_p1 = zext_ln40;

assign zext_ln61_fu_173_p1 = ap_sig_allocacmp_ch_1;

assign zext_ln69_1_fu_198_p1 = shl_ln1_fu_190_p3;

endmodule //resnet50_bottleneck_resnet50_bottleneck_Pipeline_VITIS_LOOP_61_5
