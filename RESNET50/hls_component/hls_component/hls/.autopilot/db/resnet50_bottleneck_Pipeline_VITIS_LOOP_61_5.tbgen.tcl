set moduleName resnet50_bottleneck_Pipeline_VITIS_LOOP_61_5
set isTopModule 0
...
set cdfgNum 6
set C_modelName {resnet50_bottleneck_Pipeline_VITIS_LOOP_61_5}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_out { MEM_WIDTH 15 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem1 int 16 regular {axi_master 1}  }
	{ local_out int 15 regular {array 256 { 1 3 } 1 1 }  }
	{ skip_connection_fifo int 16 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_tensor","offset": { "type": "dynamic","port_name": "output_tensor","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "local_out", "interface" : "memory", "bitwidth" : 15, "direction" : "READONLY"} , 
 	{ "Name" : "skip_connection_fifo", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ skip_connection_fifo_dout sc_in sc_lv 16 signal 2 } 
	{ skip_connection_fifo_empty_n sc_in sc_logic 1 signal 2 } 
	{ skip_connection_fifo_read sc_out sc_logic 1 signal 2 } 
	...
	{ local_out_address0 sc_out sc_lv 8 signal 1 } 
	{ local_out_ce0 sc_out sc_logic 1 signal 1 } 
	{ local_out_q0 sc_in sc_lv 15 signal 1 } 
	{ zext_ln40 sc_in sc_lv 12 signal 3 } 
	{ output_tensor sc_in sc_lv 64 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "skip_connection_fifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "skip_connection_fifo", "role": "dout" }} , 
 	{ "name": "skip_connection_fifo_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "skip_connection_fifo", "role": "empty_n" }} , 
 	{ "name": "skip_connection_fifo_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "skip_connection_fifo", "role": "read" }} , 
 	...
 	{ "name": "local_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_out", "role": "address0" }} , 
 	{ "name": "local_out_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_out", "role": "ce0" }} , 
 	{ "name": "local_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "local_out", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	...
	local_out { ap_memory {  { local_out_address0 mem_address 1 8 }  { local_out_ce0 mem_ce 1 1 }  { local_out_q0 mem_dout 0 15 } } }
	skip_connection_fifo { ap_fifo {  { skip_connection_fifo_dout fifo_data_in 0 16 }  { skip_connection_fifo_empty_n fifo_status 0 1 }  { skip_connection_fifo_read fifo_port_we 1 1 } } }
