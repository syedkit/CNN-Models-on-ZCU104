...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename local_out \
    op interface \
    ports { local_out_address0 { O 8 vector } local_out_ce0 { O 1 bit } local_out_q0 { I 15 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { skip_connection_fifo_dout { I 16 vector } skip_connection_fifo_empty_n { I 1 bit } skip_connection_fifo_read { O 1 bit } } \
} "
}
