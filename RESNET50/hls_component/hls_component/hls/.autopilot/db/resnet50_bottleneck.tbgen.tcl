set moduleName resnet50_bottleneck
set isTopModule 1
...
set cdfgNum 6
set C_modelName {resnet50_bottleneck}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem0 int 16 regular {axi_master 0}  }
	{ gmem1 int 16 regular {axi_master 1}  }
	{ gmem2 int 16 unused {axi_master 0}  }
	{ gmem3 int 16 unused {axi_master 0}  }
	{ gmem4 int 16 unused {axi_master 0}  }
	{ input_tensor int 64 regular {axi_slave 0}  }
	{ output_tensor int 64 regular {axi_slave 0}  }
	{ w_1x1_a int 64 unused {axi_slave 0}  }
	{ w_3x3 int 64 unused {axi_slave 0}  }
	{ w_1x1_b int 64 unused {axi_slave 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_tensor","offset": { "type": "dynamic","port_name": "input_tensor","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "w_1x1_a","offset": { "type": "dynamic","port_name": "w_1x1_a","bundle": "control"}}]}]} , 
 	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "w_3x3","offset": { "type": "dynamic","port_name": "w_3x3","bundle": "control"}}]}]} , 
 	{ "Name" : "gmem4", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "w_1x1_b","offset": { "type": "dynamic","port_name": "w_1x1_b","bundle": "control"}}]}]} , 
 	{ "Name" : "input_tensor", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "output_tensor", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "w_1x1_a", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
 	{ "Name" : "w_3x3", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":63}} , 
 	{ "Name" : "w_1x1_b", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":64}, "offset_end" : {"in":75}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"resnet50_bottleneck","role":"start","value":"0","valid_bit":"0"},{"name":"resnet50_bottleneck","role":"continue","value":"0","valid_bit":"4"},{"name":"resnet50_bottleneck","role":"auto_start","value":"0","valid_bit":"7"},{"name":"input_tensor","role":"data","value":"16"},{"name":"output_tensor","role":"data","value":"28"},{"name":"w_1x1_a","role":"data","value":"40"},{"name":"w_3x3","role":"data","value":"52"},{"name":"w_1x1_b","role":"data","value":"64"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"resnet50_bottleneck","role":"start","value":"0","valid_bit":"0"},{"name":"resnet50_bottleneck","role":"done","value":"0","valid_bit":"1"},{"name":"resnet50_bottleneck","role":"idle","value":"0","valid_bit":"2"},{"name":"resnet50_bottleneck","role":"ready","value":"0","valid_bit":"3"},{"name":"resnet50_bottleneck","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	resnet50_bottleneck {
		...
		input_tensor {Type I LastRead 0 FirstWrite -1}
		output_tensor {Type I LastRead 0 FirstWrite -1}
		w_1x1_a {Type I LastRead -1 FirstWrite -1}
		w_3x3 {Type I LastRead -1 FirstWrite -1}
		w_1x1_b {Type I LastRead -1 FirstWrite -1}}
	resnet50_bottleneck_Pipeline_VITIS_LOOP_40_3 {
		gmem0 {Type I LastRead 9 FirstWrite -1}
		zext_ln40 {Type I LastRead 0 FirstWrite -1}
		input_tensor {Type I LastRead 0 FirstWrite -1}
		local_in {Type O LastRead -1 FirstWrite 10}
		skip_connection_fifo {Type O LastRead -1 FirstWrite 10}}
	resnet50_bottleneck_Pipeline_VITIS_LOOP_55_4 {
		local_in {Type I LastRead 0 FirstWrite -1}
		local_out {Type O LastRead -1 FirstWrite 1}}
	resnet50_bottleneck_Pipeline_VITIS_LOOP_61_5 {
		gmem1 {Type O LastRead 3 FirstWrite 2}
		local_out {Type I LastRead 0 FirstWrite -1}
		skip_connection_fifo {Type I LastRead 1 FirstWrite -1}
		zext_ln40 {Type I LastRead 0 FirstWrite -1}
		output_tensor {Type I LastRead 0 FirstWrite -1}}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2493233", "Max" : "2493233"}
	, {"Name" : "Interval", "Min" : "2493234", "Max" : "2493234"}
]}
