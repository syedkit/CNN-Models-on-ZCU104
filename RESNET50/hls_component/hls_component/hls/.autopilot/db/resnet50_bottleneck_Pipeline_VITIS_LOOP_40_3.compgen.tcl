...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename local_in \
    op interface \
    ports { local_in_address0 { O 8 vector } local_in_ce0 { O 1 bit } local_in_we0 { O 1 bit } local_in_d0 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_in'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_input_tensor \
    op interface \
    ports { input_tensor { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 5 \
    name skip_connection_fifo \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_skip_connection_fifo \
    op interface \
    ports { skip_connection_fifo_din { O 16 vector } skip_connection_fifo_full_n { I 1 bit } skip_connection_fifo_write { O 1 bit } } \
} "
}
...
set InstName resnet50_bottleneck_flow_control_loop_pipe_sequential_init_U
set CompName resnet50_bottleneck_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix resnet50_bottleneck_ \
}"
} else {
