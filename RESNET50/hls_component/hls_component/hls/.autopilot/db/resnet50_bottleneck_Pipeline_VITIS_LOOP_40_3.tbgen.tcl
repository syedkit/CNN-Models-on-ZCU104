set moduleName resnet50_bottleneck_Pipeline_VITIS_LOOP_40_3
set isTopModule 0
...
set cdfgNum 6
set C_modelName {resnet50_bottleneck_Pipeline_VITIS_LOOP_40_3}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_in { MEM_WIDTH 16 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ gmem0 int 16 regular {axi_master 0}  }
	{ zext_ln40 int 12 regular  }
	{ input_tensor int 64 regular  }
	{ local_in int 16 regular {array 256 { 0 3 } 0 1 }  }
	{ skip_connection_fifo int 16 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_tensor","offset": { "type": "dynamic","port_name": "input_tensor","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "zext_ln40", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
 	{ "Name" : "input_tensor", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "local_in", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "skip_connection_fifo", "interface" : "fifo", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ skip_connection_fifo_din sc_out sc_lv 16 signal 4 } 
	{ skip_connection_fifo_full_n sc_in sc_logic 1 signal 4 } 
	{ skip_connection_fifo_write sc_out sc_logic 1 signal 4 } 
	{ zext_ln40 sc_in sc_lv 12 signal 1 } 
	{ input_tensor sc_in sc_lv 64 signal 2 } 
	{ local_in_address0 sc_out sc_lv 8 signal 3 } 
	{ local_in_ce0 sc_out sc_logic 1 signal 3 } 
	{ local_in_we0 sc_out sc_logic 1 signal 3 } 
	{ local_in_d0 sc_out sc_lv 16 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "skip_connection_fifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "skip_connection_fifo", "role": "din" }} , 
 	{ "name": "skip_connection_fifo_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "skip_connection_fifo", "role": "full_n" }} , 
 	{ "name": "skip_connection_fifo_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "skip_connection_fifo", "role": "write" }} , 
 	{ "name": "zext_ln40", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "zext_ln40", "role": "default" }} , 
 	{ "name": "input_tensor", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "input_tensor", "role": "default" }} , 
 	{ "name": "local_in_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_in", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	zext_ln40 { ap_none {  { zext_ln40 in_data 0 12 } } }
	input_tensor { ap_none {  { input_tensor in_data 0 64 } } }
	local_in { ap_memory {  { local_in_address0 mem_address 1 8 }  { local_in_ce0 mem_ce 1 1 }  { local_in_we0 mem_we 1 1 }  { local_in_d0 mem_din 1 16 } } }
	skip_connection_fifo { ap_fifo {  { skip_connection_fifo_din fifo_data_in 1 16 }  { skip_connection_fifo_full_n fifo_status 0 1 }  { skip_connection_fifo_write fifo_port_we 1 1 } } }
}
